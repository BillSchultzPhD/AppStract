...
article_url <- "https://www.journals.uchicago.edu/doi/10.1086/"
...
# Most recent IO (as of document date)

``` {r AppStract_IO, include=FALSE}
...
# setup
latest_issue_url <- "https://www.cambridge.org/core/journals/international-organization/latest-issue"
article_url <- "https://www.cambridge.org/core/journals/international-organization/article/"

internal_links <- Rcrawler::LinkExtractor(url = latest_issue_url)$InternalLinks

# select only articles and not other internal links on page
# no extra exlucsions needed for IO
internal_links <- internal_links[grepl(article_url, internal_links)]
...
``` {r JOP_IO, results = 'asis', echo = FALSE}

kable(out, caption = "International Organization")

```

# Most recent WP (as of document date)

``` {r AppStract_WP, include=FALSE}
...
# setup
latest_issue_url <- "https://www.cambridge.org/core/journals/world-politics/latest-issue"
article_url <- "https://www.cambridge.org/core/journals/world-politics/article/"

internal_links <- Rcrawler::LinkExtractor(url = latest_issue_url)$InternalLinks

# select only articles and not other internal links on page
# no extra exlucsions needed for WP
internal_links <- internal_links[grepl(article_url, internal_links)]
...
``` {r JOP_WP, results = 'asis', echo = FALSE}

kable(out, caption = "World Politics")

```

# Most recent CPS (as of document date)

``` {r AppStract_CPS, include=FALSE}
...
# setup
latest_issue_url <- "https://journals.sagepub.com/toc/CPS/current"
article_url <- "https://journals.sagepub.com/doi/full/10.1177/"

internal_links <- Rcrawler::LinkExtractor(url = latest_issue_url)$InternalLinks

# select only articles and not other internal links on page
# no extra exlucsions needed for CPS
internal_links <- internal_links[grepl(article_url, internal_links)]
...
``` {r JOP_CPS, results = 'asis', echo = FALSE}

kable(out, caption = "Comparative Political Studies")

```

# Most recent PA (as of document date)

``` {r AppStract_PA, include=FALSE}
...
# setup
latest_issue_url <- "https://www.cambridge.org/core/journals/political-analysis/latest-issue"
article_url <- "https://www.cambridge.org/core/journals/political-analysis/article/"

internal_links <- Rcrawler::LinkExtractor(url = latest_issue_url)$InternalLinks

# select only articles and not other internal links on page
# no extra exlucsions needed for PA
internal_links <- internal_links[grepl(article_url, internal_links)]
...
``` {r JOP_PA, results = 'asis', echo = FALSE}

kable(out, caption = "Political Analysis")

```

# Most recent JTP (as of document date)

``` {r AppStract_JTP, include=FALSE}
...
# setup
latest_issue_url <- "https://journals.sagepub.com/toc/JTP/current"
article_url <- "https://journals.sagepub.com/doi/full/10.1177/"
...
``` {r JTP_kable, results = 'asis', echo = FALSE}

kable(out, caption = "Journal of Theoretical Politics")
